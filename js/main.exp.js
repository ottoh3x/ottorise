!(function e() {
  ...
  (String.prototype.toHHMMSS = function () {
    ...
    (function (e) {
      ...
      function i(t) {
        ...
        i();
        for (
          var n, l, c = t[0], h = t[1], d = t[2], p = 0, m = [];
          p < c.length;
          p++
        )
          (l = c[p]),
      ...
      function a() {
        for (var e, t = 0; t < o.length; t++) {
          for (var s = o[t], i = !0, a = 1; a < s.length; a++)
            0 !== r[s[a]] && (i = !1);
          i && (o.splice(t--, 1), (e = l((l.s = s[0]))));
        }
        return e;
      }
      var n = {},
      ...
      function (e, t, i) {
        let n = i(5),
          ...
          p = i(23),
          m = i(128),
          { lerp: v, clampNumber: g, hideCaptchaBadge: f } = i(8),
          { htmlEncode: y } = i(8),
          w,
          b = {
            connectionUrl: null,
        ...
        class k {
          constructor() {
            (this.running = !1),
              ...
              (this.settings = o),
              (this.renderer = l),
              (this.skinLoader = new m()),
              u.virus.loadVirusFromUrl(o.virusImageUrl),
              (this.state = b),
              h.useGame(this),
              this.playback,
              (this.connection = new (class e {
                ...
                onClosed(e) {
                  ...
                  let t;
                  if (1003 === e.code)
                    (t = 1500), C("Server restarting...", !1);
                  else {
                    t = 3500 + ~~(100 * Math.random());
                    let s = "You have been disconnected";
                    e.reason && (s += ` (${e.reason})`), C(s, !0);
                  }
                  setTimeout(() => {
                    this.opened || w.events.$emit("reconnect-server");
                  }, t),
                    w.showMenu(!0);
                }
                onRejected() {
                  delete w.currentWsId,
                    (this.opened = !1),
                    C("Connection rejected", !0);
                }
                open(e) {
                  w.dual.close(),
                    w.running && w.stop(),
                    this.close(),
                    w.events.$emit("chat-clear"),
                    (this.opened = !0);
                  let t = (w.ws = new WebSocket(e, "tFoL46WDlZuRja7W6qCl"));
                  (t.binaryType = "arraybuffer"),
                    (t.packetCount = 0),
                    (t.onopen = () => {
                      w.connection.opened &&
                        ((w.currentWsId = t.id = this.socketCount++),
                        (w.state.connectionUrl = e),
                        (t.onclose = this.onClosed.bind(this)));
                    }),
                    (t.onclose = this.onRejected.bind(this)),
                    (t.onmessage = (e) => {
                      let { data: t } = e;
                      (w.nwData += t.byteLength),
                        w.parseMessage(s.fromBuffer(t));
                    });
                }
                close() {
                  w.dual.close(), (w.debugElement.innerHTML = "");
                  let { ws: e } = w;
                  e &&
                    ((e.onmessage = null),
                    (e.onclose = null),
                ...
                sendMouse() {
                  ...
                  this.send(e, a.focused),
                    a.connected &&
                      ((w.isAlive(!1) && w.isAlive(!0)) ||
                        this.send(e, w.isAlive(!1)));
                }
                sendOpcode(e, t) {
                  let i = s.fromSize(1);
                ...
                ping() {
                  (w.pingStamp = performance.now()), this.sendOpcode(3);
                }
                sendJoinData(e, t) {
                  let i = s.fromSize(2 + e.length + 7);
                  i.writeUInt8(5),
                    i.writeUInt8(w.clientVersion),
                    e.forEach((e) => i.writeUInt8(e)),
                    r(i, !!t);
                  let a = localStorage.vanisToken;
                  a &&
                    /^wss?:\/\/[a-zA-Z0-9_-]+\.vanis\.io/i.test(w.ws.url) &&
                    i.writeStringNT(a),
                    this.send(i, t, !!t);
                }
          ...
          start(e) {
            ...
            let i =
                ...
                o.useWebGL &&
                o.showBackgroundImage,
              a = (this.scene = new c(t, i));
            if (
              ((a.container.alpha = o.gameAlpha || 1),
              ...
              b.selectedServer &&
                b.connectionUrl !== b.selectedServer.url &&
                (b.selectedServer = null),
              this.replaying)
            ) {
              let { playback: n } = this,
                r = e.replayUpdates;
              n.set(r),
                ...
                this.events.$emit("show-replay-controls", r.length),
              ...
              (this.splitCount = 0),
                ...
                (this.mouseFrozen = !1),
                o.minimapEnabled && this.events.$emit("minimap-show"),
                o.showChat &&
          ...
          stop() {
            ...
            e.opened && e.close(),
              ...
              (b.lifeState = 0),
              (b.allowed = !1),
              (b.playButtonDisabled = !1),
              (b.playButtonText = "Play"),
          ...
          static everySecond() {
            (w.isAlive(!1) || w.isAlive(!0)) && w.timeAlive++,
              w.nwData > w.nwDataMax && (w.nwDataMax = w.nwData),
              (w.nwDataTotal += w.nwData);
            let { connection: e } = w,
              { debugElement: t } = w;
            if (t) {
              if ((o.debugStats || o.clientStats) && e.opened) {
                let s = w.dual.connected,
                  i = "";
                if (
                  (o.debugStats &&
                    !w.replaying &&
            ...
            <b>(NET TOTAL)</b> ${(w.nwDataTotal / 1024 / 1024).toFixed(
              0
            )} MB <br>
            <br>`),
                  o.clientStats)
        ...
        `;
            ...
            (w.nwData = 0), e.opened && e.ping();
            let { dual: r } = w;
            r.connected &&
              ((r.pingStamp = performance.now()), e.sendOpcode(3, !0));
          }
          clearCells() {
          ...
          onTick() {
            ...
            let { scene: n } = this;
            n.sort();
            let r = this.updateCamera();
            if (r) {
              this.score = r;
              let { highestScore: o } = this;
              this.highestScore = o ? (o < r ? r : o) : r;
          ...
          updateCamera(e = !1) {
            let { scene: t, camera: s } = this,
              ...
              a = g(i / o.cameraMoveDelay, 0, 1),
              n = g(i / o.cameraZoomDelay, 0, 1),
              r = (t.container.pivot.x = v(s.ox, s.nx, a)),
              l = (t.container.pivot.y = v(s.oy, s.ny, a)),
              c = v(s.oz, s.nz, n);
            ...
            if (this.spectating) {
              ...
              if (!this.replaying) {
                let { dual: b } = this;
                if (b.connected) {
                  let C = b.getDistanceFromOwner();
                  y = !!o.singleView || null == C || C > 8e3;
                }
              }
              let _ = 0,
                k = this.allCells,
                x;
              for (x of this.ownedCells.values()) {
                let S = k.get(x);
                if (y && S.pid != w.activePid) continue;
                let M = Math.round(Math.pow(S.nSize / 10, 2));
                (d += S.nx * M), (u += S.ny * M), (_ += S.nSize), (p += M);
              }
              p
                ? ((d /= p),
                  (u /= p),
                  o.autoZoom && (h *= Math.pow(Math.min(64 / _, 1), 0.27)))
                : ((d = s.nx), (u = s.ny));
            }
            return e
              ? ((s.ox = r),
          ...
          createThumbnail(e = 240, t = 135) {
            ...
            let r = a.plugins.extract.canvas(n),
          ...
          getMassText(e) {
            return !o.shortMass || e < 1e3
              ? e.toFixed(0)
              : (e / 1e3).toFixed(1) + "k";
          }
          shouldAutoRespawn(e) {
            return !this.app.showMenu && (e ? o.mbAutorespawn : o.autoRespawn);
          }
          triggerDeathDelay(e) {
            if (
              ...
              e
                ...
                : ((b.deathDelay = !1), (b.autoRespawning = !1)),
              !o.mbAutorespawn && !o.autoRespawn)
            ) {
              let t = [];
          ...
          triggerAutoRespawn(e) {
            if (e) {
              ...
              (b.deathDelay = !1), (b.autoRespawning = !1), this.actions.join();
          }
          handleDeath(e, t) {
            e.readUInt16LE(),
            ...
            this.shouldAutoRespawn(t)
              ? t
                ...
                : ((b.autoRespawning = !0), (this.ticksSinceDeath = 0))
          ...
          parseMessage(e) {
            ...
            switch (t) {
              ...
              case 3: {
                let r = performance.now() - this.pingStamp;
                this.updateStats(Math.round(r));
                return;
              }
              case 4: {
                let { playerManager: o } = this;
                for (;;) {
                  let l = e.readUInt16LE();
                  if (0 == l) return;
                  o.delayedRemovePlayer(l);
                }
              }
              case 6:
              ...
              case 7: {
                ...
                if (2 & c) {
                  let m = e.readUInt16LE();
                  h = this.playerManager.getPlayer(m);
                }
              ...
              case 8:
                ...
                return;
              case 9: {
                let { playerManager: v } = this,
                  g = this.activePid;
                g && v.getPlayer(g).setOutline(16777215),
                  (g = this.activePid = e.readUInt16LE()),
                  v.getPlayer(g).setOutline(16711935);
                return;
              }
              case 10: {
                (this.timeStamp = performance.now()), (b.lifeState = 0);
                let f = (this.alive = this.parseCells(e)),
                  { dual: C } = this;
                (b.lifeState = (f ? 1 : 0) + (C.alive ? 2 : 0)),
                  f && (this.spectating = !1);
                let { replay: _ } = this;
                f && !this.replaying
                  ? _.add(e.view, !1)
              ...
              case 12:
                ...
                return;
              case 13: {
                let k = { pid: e.readInt16LE(), text: e.readString16() };
                if (0 == k.pid) {
                  let { selectedServer: x } = b;
                  x &&
                    /Welcome to Vanis\.io,.+\!/.test(k.text) &&
                    (k.text = `Connected to ${x.region} ${x.name}`),
                    this.events.$emit("chat-message", k.text);
                  return;
                }
                let S = this.playerManager.getPlayer(k.pid);
                if (!S) return;
                k.from = S.name;
                let { nameColorCss: M } = S;
                M && (k.fromColor = M), this.events.$emit("chat-message", k);
                return;
              }
              case 14: {
                let I = e.readUInt8(),
                ...
                4 & I && (T.timer = e.readUInt16LE());
                let L = e.readString();
                (T.title = y(L)), n.toast.fire(T);
                return;
              }
              case 15: {
                let { playerManager: P } = this;
                for (;;) {
                  let U = e.readUInt16LE();
                  if (0 === U) return;
                  let R = e.readString16(),
                    A = e.readString(),
                    N = { pid: U, nickname: R, skinUrl: A };
                  P.setPlayerData(N);
                }
              }
              case 16:
                ...
                return;
              case 17:
                (w.camera.sx = e.readInt16LE()),
                  (w.camera.sy = e.readInt16LE());
                return;
              case 18: {
                let { replay: D } = this;
                D.clear(!1), this.clearCells();
                return;
              }
              case 19: {
                let O = 0 !== e.readUInt8();
                if ((this.events.$emit("xp-update", e.readUInt32LE()), !O))
                  return;
                let B = e.readUInt16LE(),
                  F = atob("WW91IGhhdmUgcmVhY2hlZCBsZXZlbA==");
                n.toast.fire({
                  background: "#b58b00",
                  title: `${F} ${B}!`,
                  type: "success",
              ...
              case 25:
                ...
                return;
              case 26:
                (b.playButtonDisabled = !!e.readUInt8()),
                  e.length > e.offset + 1 &&
                    (b.playButtonText = e.readString() || "Play");
                return;
            }
          }
        }
        e.exports = w = window.GAME = new k();
      },
      ,
      ,
      function (e) {
          ...
          (window.SwalAlerts = e.exports =
            {
              toast: a,
              alert: function (e) {
                i.fire({ text: e, confirmButtonText: "OK" });
              },
              ...
              if (t.has(e)) return t.get(e);
              {
                let { cellSize: s, textureSize: i } = this,
                  a = new PIXI.Graphics()
                    ...
                    .endFill();
                a.position.set(s);
                let r = PIXI.RenderTexture.create(i, i);
                return t.set(e, r), n.render(a, r), r;
              }
            }
          })(),
        ...
        class o {
          constructor(e) {
            (this.id = e.id || 0),
              ...
              (this.destroyed = !1),
              (this.texture = e.texture || n.getTexture(0)),
          ...
          destroy(e) {
            ...
            let { id: t } = this,
              { cells: s } = this.dual ? i.dual : i;
            s.delete(t),
              this.pid && i.ownedCells.delete(t),
              (this.destroyed = !0),
              e ? i.destroyedCells.push(this) : this.destroySprite();
          }
          destroySprite() {
            this.sprite && (this.sprite.destroy(), (this.sprite = null));
          }
        }
        (o.prototype.updateStamp = 0),
          (o.prototype.newPositionScale = 1),
          (e.exports = o);
      },
      ,
      ,
      ...
      function (e, t, s) {
        ...
        "string" == typeof (a = a.__esModule ? a.default : a) &&
          (a = [[e.i, a, ""]]);
        var n =
          (i(a, { insert: "head", singleton: !1 }), a.locals ? a.locals : {});
        e.exports = n;
      },
      function (e, t, s) {
        "use strict";
        ...
        e.exports = {
          ...
          methods: {
            ...
            onMinimapShow() {
              this.interval ||
                ((this.showMinimap = !0),
                (this.minimapStatsBottom = r + 10),
                i.events.$on("minimap-positions", this.updatePositions),
                (this.interval = setInterval(this.render, 1e3 / o)));
            },
            onMinimapHide() {
              this.interval &&
                ((this.showMinimap = !1),
            ...
            createNode(e, t, s, i) {
              ...
              if ((a.addChild(n), t)) {
                ...
                r.anchor.set(0.5), (r.pivot.y = 15), a.addChild(r);
              }
              h[e] = a;
            },
            destroyNode(e) {
            ...
            updatePositions(e) {
              ...
              for (var t = 0; t < e.length; t++) {
                var s = e[t],
                  i = h[s.pid];
                i &&
                  ((i.newPosition.x = s.x * r),
                  (i.newPosition.y = s.y * r),
                  c.addChild(i));
              }
              this.render();
            },
            ...
            drawLocationGrid(e, t) {
              ...
              for (var i = 1; i < t; i++) {
                var a = i * s;
                e.moveTo(a, 0), e.lineTo(a, r), e.moveTo(0, a), e.lineTo(r, a);
              }
            ...
            drawLocationCodes(e, t) {
              ...
              (e.globalAlpha = 0.1),
                ...
                (e.fillStyle = "#ffffff");
              for (var a = 0; a < t; a++)
                for (var n = a * s + i, o = 0; o < t; o++) {
                  var l = String.fromCharCode(97 + o).toUpperCase() + (a + 1),
                    c = o * s + i;
          ...
          o = {
            toggleAutoRespawn() {
              ...
              (t += e ? "disabled" : "enabled"),
                n.toast.fire({ type: "info", title: t, timer: 1500 });
            },
            respawn() {
              r.join(i.dual.focused), i.showMenu(!1);
            },
            feed: r.feed.bind(r),
            feedMacro: r.feed.bind(r, !0),
            split: r.split.bind(r, 1),
            splitx2: r.split.bind(r, 2),
            splitx3: r.split.bind(r, 3),
            splitMax: r.split.bind(r, 4),
            split32: r.split.bind(r, 5),
            split64: r.split.bind(r, 6),
            split128: r.split.bind(r, 7),
            split256: r.split.bind(r, 8),
            multi1: r.multicombo.bind(r, 1),
            multi2: r.multicombo.bind(r, 2),
            multi3: r.multicombo.bind(r, 3),
            linesplit: r.linesplit.bind(r),
            freezeMouse: r.freezeMouse.bind(r),
            lockLinesplit: r.lockLinesplit.bind(r),
            stopMovement: r.stopMovement.bind(r),
            toggleSkins: r.toggleSkins.bind(r),
            toggleNames: r.toggleNames.bind(r),
            toggleFood: r.toggleFood.bind(r),
            toggleMass: r.toggleMass.bind(r),
            toggleChat: r.toggleChat.bind(r),
            toggleChatToast: r.toggleChatToast.bind(r),
            toggleHud: r.toggleHud.bind(r),
            spectateLock: r.spectateLockToggle.bind(r),
            selectPlayer: r.targetPlayer.bind(r),
            saveReplay() {
              let { dual: e } = i;
              i.replay.save(e.focused);
            },
            zoomLevel1: r.setZoomLevel.bind(r, 1),
            zoomLevel2: r.setZoomLevel.bind(r, 2),
            zoomLevel3: r.setZoomLevel.bind(r, 3),
            zoomLevel4: r.setZoomLevel.bind(r, 4),
            zoomLevel5: r.setZoomLevel.bind(r, 5),
            multibox() {
              let { dual: e } = i;
              e.switch();
            },
        ...
        e.exports = i.hotkeyManager = new (class e {
          ...
          loadHandlers(e) {
            ...
            (this.releaseHandlers = {}),
              "feedMacro" in e &&
                (this.releaseHandlers[e.feedMacro] = r.feed.bind(r, !1));
          }
          press(e) {
        ...
        var i = function () {
            ...
            return t("div", [
              ...
              t(
                ...
                [
                  t("canvas", { ref: "locations", attrs: { id: "locations" } }),
                  this._v(" "),
                  t("canvas", { ref: "minimap", attrs: { id: "minimap" } }),
                ]
              ),
            ]);
          },
            ...
            return s("transition", { attrs: { name: "fade", appear: "" } }, [
              s("div", { staticClass: "modal" }, [
                ...
                s(
                  ...
                  { staticClass: "wrapper" },
                  [
                    s("transition", { attrs: { name: "scale", appear: "" } }, [
                      s(
                        "div",
      ...
      function (e, t, s) {
        let i = s(1),
          ...
          d = (e, t, s) => {
            let a = 15 & t.type,
              { id: d } = t;
            if ((null == t.x || null == t.size) && (3 == a || 4 == a)) {
              let { food: u } = i,
                p = (t.size =
                  3 == a
                    ? u.ejectedSize || 1
                    : u.minSize + (d % u.stepSize) || 1);
              if (4 == a) {
                let { border: m } = i;
                (t.x =
                  m.minx + p + (m.width - 2 * p) * i.seededRandom(65536 + d)),
                  (t.y =
                    m.miny +
                    p +
                    (m.height - 2 * p) * i.seededRandom(131072 + d));
              }
            }
            let v;
            if (e.has(d))
              ...
              switch (a) {
                case 1: {
                  let g = i.playerManager.getPlayer(t.pid);
                  (t.texture = g.texture), (v = new n(t, g));
                  break;
                }
                case 2:
                  v = new r(t);
              ...
              let { scene: b } = i;
              b[3 & a ? "addCell" : "addFood"](v.sprite), e.set(d, v);
            }
            let { x: C, y: _ } = t;
            null != C && ((v.nx = C), (v.ny = _));
            let { size: k } = t;
            null != k && (v.nSize = k), (v.updateStamp = i.timeStamp);
            let { player: x } = v;
            if (!x || t.dual) return;
            let { replay: S } = i;
            S.recording() ? (x.lastUpdateTick = s) : delete x.lastUpdateTick;
          },
          { clampNumber: u } = s(8),
          p = (e, t, s) => {
            if (!e.has(t)) return;
            ...
            if (!e.has(s)) return void n.destroy();
            let r = e.get(s);
            n.update(),
              n.destroy(a.eatAnimation),
              (n.nx = r.x),
              (n.ny = r.y),
              (n.nSize = 0),
              (n.newPositionScale = u(n.size / r.nSize, 0, 1)),
              (n.updateStamp = i.timeStamp);
          },
          m = (e) => {
            let { view: t } = e;
            null == t.packetId && (t.packetId = i.ws.packetCount++);
            let s = t.packetId,
              { cells: a } = i,
              { dual: n } = i,
              r = n.opened ? n.cells : null,
              o = !1;
            for (;;) {
              let l = e.readUInt8(),
                c = 15 & l;
              if (0 == l) break;
              let h = 1 == c ? e.readUInt16BE() : null,
                u = e.readUInt16BE(),
                m = {
                  type: l,
                  pid: h,
              ...
              if (
                (32 & l || ((m.x = e.readInt16BE()), (m.y = e.readInt16BE())),
                64 & l || (m.size = e.readUInt16BE()),
                (l << 24) >> 24 < 0)
              ) {
                let v = e.readUInt8();
                m.flags = v | (m.flags | +(v > 15));
              }
              (r && r.has(u)) || d(a, m, s), h == i.playerId && (o = !0);
            }
            let g = e.readUInt16BE();
            for (; g--; ) {
              let f = e.readUInt16BE();
              a.has(f) && a.get(f).destroy();
            }
            for (g = e.readUInt16BE(); g--; ) {
              let y = e.readUInt16BE(),
                w = e.readUInt16BE();
              a.has(y) && p(a, y, w);
            }
            return o;
          };
        (i.parseCells = m), (e.exports = { addOrUpdateCell: d, removeCell: p });
      },
      function (e, t, s) {
        var i = s(140);
        function a(e, t, s, a) {
          var n = e.length,
            r = i._malloc(n),
            o = new Uint8Array(i.HEAPU8.buffer, r, n);
          o.set(e);
          var l = t(r, a);
          if (!s) {
      ...
      function (e, t, s) {
        ...
        e.exports = class e {
          ...
          resetMassTextStyle(e) {
            ...
            for (
              PIXI.BitmapFont.from("mass", t, { chars: "1234567890k." });
            ...
            return (
              ...
              (n[e] =
                ...
                (h =
                  ...
                  o.endFill(),
                  o)).position.set(c),
                (d = PIXI.RenderTexture.create(l, l)),
                a.render(h, d),
                d))
            );
          },
      ...
      function (e, t, s) {
        ...
        e.exports = {
          ...
          loadVirusFromUrl: async function (e) {
            await r,
              (r = new Promise(async (t) => {
                var s = await a(e),
                  r = PIXI.Sprite.from(s, void 0, 18);
      ...
      function (e, t, s) {
        ...
        e.exports = class e {
          ...
          setPlayerData({
            ...
            !this.players.has(e) &&
              (this.players.set(e, new a(e, o)), o && this.botCount++);
          ...
          sweepRemovedPlayers() {
            ...
            for (; a < this.playersRemoving.length; ) {
              ...
              let r = this.players.get(n);
              !s || (r.lastUpdateTick && s > r.lastUpdateTick)
      ...
      function (e, t, s) {
        ...
        e.exports = class e {
          ...
          createCellContainer() {
            ...
            return e.pivot.set(-o / 2), e.addChild(h(this.getCellColor())), e;
          }
          createSkinSprite(e) {
          ...
          setNameColor(e) {
            return (
              ...
              (this.nameColor = e),
              (this.nameColorCss = e && PIXI.utils.hex2string(e)),
              e
            );
          }
          setName(e, t) {
            return (
              e || (e = "Unnamed"),
              (this.nameFromServer !== e || this.nameColorFromServer !== t) &&
          ...
          applyNameToSprite() {
            ...
            if (
              ...
              let r = n || (this.isMe ? 16747520 : null);
              d.events.$emit("minimap-create-node", this.pid, s, n, r);
            }
          }
          setNameSprite(e, t) {
            this.nameSprite
              ? (this.nameSprite.text = e)
              : (this.nameSprite = new PIXI.Text(e, i.nameTextStyle)),
      ...
      function (e, t, s) {
        ...
        e.exports = class e {
          ...
          createLoader(e) {
            return { image: null, errored: null, callbacks: [e] };
          }
          clearCallbacks() {
            this.loaders.clear();
          }
      ...
      function (e, t, i) {
        let a = i(131),
            ...
            let t = e.map((e) => {
                ...
                return (
                  ...
                  e.nameColorFromServer &&
                    (t.nameColor = e.nameColorFromServer),
                  t
                );
              }),
              i = JSON.stringify(t);
          ...
          v = (e) => {
            ...
            let r = s.fromSize(1 + t + 1 + 2 + 2);
            r.writeUInt8(10);
            for (let o = 0; o < i; o++) {
              let l = e[o],
                c = 254 & l.flags;
              r.writeUInt8(l.type | (c ? 128 : 0)),
                1 === l.type && r.writeUInt16BE(l.pid),
                r.writeUInt16BE(l.id),
                r.writeInt16BE(l.x),
                r.writeInt16BE(l.y),
                r.writeUInt16BE(l.size),
                c && r.writeUInt8(c);
            }
            return (
              r.writeUInt8(0), r.writeUInt16BE(0), r.writeUInt16BE(0), r.view
            );
          };
        n.replay = new (class e {
          ...
          add(e, t) {
            ...
            s.push(
              ...
              i.push(e);
            let r = 25 * l.replayDuration;
            i.length > r && (i.shift(), s.shift());
          }
          clear(e) {
            let t = this.cells[+e],
              s = this.packets[+e];
          ...
          save(e) {
            ...
            i.splice(0, 1, v(t.at(0)));
            let c = ["REPLAY", 4];
            c.push(n.createThumbnail()), c.push(d(n.initialDataPacket.buffer));
            let { dual: u } = n;
            if (u.connected) {
              let g = s.fromSize(3);
              g.writeUInt8(8), g.writeUInt16LE(u.pid), c.push(d(g.buffer));
            }
            c.push(m(a)),
              c.push(p),
            ...
            h.setItem(r(), f, () => {
              ...
              "string" == typeof e
                ...
                o.toast.fire({ type: "error", title: t });
            });
          }
        })();
      },
      ...
      function (e, t, s) {
        let i = s(1),
          { addOrUpdateCell: a, removeCell: n } = s(79);
        e.exports = i.playback = new (class e {
          ...
          parse(e) {
            ...
            for (;;) {
              ...
              if (
                (32 & i || ((o.x = e.readInt16BE()), (o.y = e.readInt16BE())),
                64 & i || (o.size = e.readUInt16BE()),
                (i << 24) >> 24 < 0)
              ) {
                let l = e.readUInt8();
                o.flags = l | (o.flags | (l > 15));
              }
              s[r] = o;
            }
            let c = e.readUInt16BE();
            for (; c--; ) {
              let h = e.readUInt16BE();
              this.removeCell(h, 0);
            }
            for (c = e.readUInt16BE(); c--; )
              this.removeCell(e.readUInt16BE(), e.readUInt16BE());
          }
          reset() {
            let { updates: e } = this;
          ...
          setStartingFrame() {
            ...
            for (let c = 1; c < t.length; c++) {
              ...
              for (let u in d[0]) {
                ...
                let p = d[0][u],
                  m = h[0][u];
                16 & p.type && (p.pid = m.pid),
                  32 & p.type && ((p.x = m.x), (p.y = m.y)),
                  64 & p.type && (p.size = m.size);
              }
              for (let v in h[0]) v in d[3] || v in d[0] || (d[0][v] = h[0][v]);
            }
          }
          seek(e, t) {
            let { cells: s } = i,
              r = this.updates[e];
            for (let o of s.keys()) (!t && o in r[0]) || n(s, o, 0);
            for (let l in r[0]) a(s, r[0][l], 0);
            (this.index = e), i.updateCamera(!0);
          }
          next() {
            let { updates: e } = this;
            if (this.index < e.length) {
              let [t, s, r] = e[this.index++],
                { cells: o } = i;
              for (let l in t) a(o, t[l], 0);
              let c = s.length,
                h = 0;
              for (; h < c; ) n(o, s[h++], 0);
              for (c = r.length, h = 0; h < c; ) n(o, r[h++], r[h++]);
              i.updateCamera(!0);
            } else this.seek(0, !0);
          ...
          onUpdate() {
            ...
            if (
              (r.massShown &&
                !this.massText &&
                s &&
                ((this.massText = i.massTextPool.pop() || o(a.massTextStyle)),
              ...
              r.nameShown &&
                ...
                r.nameSprite &&
                s &&
                ((this.nameSprite = new PIXI.Sprite(r.nameSprite.texture)),
            ...
            this.crownSprite &&
              ...
              this.nameSprite && (this.nameSprite.visible = r.nameShown && s),
              this.tagSprite && (this.tagSprite.visible = a.showTag);
            let { directionSprite: u } = this;
            if (u && (u.visible = a.showDir && !r.isMe)) {
              let p = 0,
                m = !1,
                { ox: v, oy: g, nx: f, ny: y } = this;
              f > v
                ? (f - v < 3 && (m = !0),
                  (p =
                    y < g
            ...
            if (w) {
              if (r.massShown && s) {
                let b = i.getMassText((this.nSize * this.nSize) / 100);
                (w.text = b), (w.visible = !0);
              } else w.visible && (w.visible = !1);
            }
          }
          onDestroy() {
            this.arrowSprite &&
      ...
      function (e, t, s) {
        let i = s(1),
          ...
          { cells: n } = s(12),
          r = s(14),
          o = () => n.getTexture(parseInt(a.ejectedColor, 16)),
          { clampNumber: l } = s(8);
        class c extends r {
          constructor(e) {
            (e.texture = o()), super(e), (this.sprite.alpha = 0);
          }
          reloadTexture() {
      ...
      function (e, t, i) {
        let n = i(1),
          { state: r } = n,
          o = i(78),
          { addOrUpdateCell: l, removeCell: c } = i(79);
        e.exports = n.dual = new (class e {
          ...
          parseCells(e) {
            let { view: t } = e,
              s = (t.packetId = this.ws.packetCount++),
              i = n.cells,
              { cells: a } = this,
              r = !1;
            for (;;) {
              ...
              if (
                (32 & o || ((p.x = e.readInt16BE()), (p.y = e.readInt16BE())),
                64 & o || (p.size = e.readUInt16BE()),
                (o << 24) >> 24 < 0)
              ) {
                let m = e.readUInt8();
                p.flags = m | (p.flags | +(m > 15));
              }
              i.has(u) || l(a, p, s), d == this.pid && (r = !0);
            }
            let v = e.readUInt16BE();
            for (; v--; ) {
              let g = e.readUInt16BE();
              a.has(g) && a.get(g).destroy();
            }
            for (v = e.readUInt16BE(); v--; ) {
              let f = e.readUInt16BE(),
                y = e.readUInt16BE();
              a.has(f) && c(a, f, y);
            }
          ...
          handleMessage(e) {
            ...
            switch (i) {
              case 1: {
                let r = o(t);
                (n.multiboxPid = this.pid = r.playerId),
              ...
              case 10: {
                ...
                let c = (this.alive = this.parseCells(t)),
                  { replay: h } = n;
                if (
          ...
          updateOutlines() {
            ...
            switch (
              ...
              case 1: {
                ...
                let o = +("0x" + settings.mbColor);
                this.focused
                  ? (i.setOutline(16777215), a.setOutline(o))
                  : (a.setOutline(16777215), i.setOutline(o));
                break;
              }
              case 2:
              case 3:
          ...
          switch() {
            if (!this.opened) return void this.open();
            ...
            this.feedTimeout &&
              ...
              e
                ? (n.isAlive(!1) || r.autoRespawning || n.actions.join(),
      ...
      function (e, t, s) {
        ...
        let o = /firefox/i.test(navigator.userAgent)
            ? "DOMMouseScroll"
            : "wheel",
          l = (e) => {
          ...
          p = (e) => {
            let t = "MOUSE" + e.button;
            a.release(t), r.delete(t);
          },
          m = (e) => {
            let t = e.target === n;
            if (!t && e.target !== document.body) return;
            let s = a.convertKey(e.code);
            if (!r.has(s) && (!e.ctrlKey || "TAB" !== s)) {
              if ((r.add(s), "ESCAPE" === s)) {
                if (i.replaying) r.clear(), i.stop(), i.showMenu(!0);
                else {
                  let o = !!i.dual.autoRespawning;
                  (i.state.autoRespawning || o) && i.triggerDeathDelay(o),
                    i.showMenu();
                }
                return;
              }
        ...
        i.eventListeners = (e) => {
          e
            ? (n.addEventListener("contextmenu", l),
              ...
              n.addEventListener(o, h, { passive: !0 }),
            ...
            : (n.removeEventListener("contextmenu", l),
              ...
              document.body.removeEventListener("keyup", v),
      ...
      function (e, t, i) {
        let a = i(1),
          n = i(4),
          { writeUserData: r, clampNumber: o } = i(8);
        a.actions = new (class e {
          ...
          join(e) {
            ...
            let t = s.fromSize(8);
            t.writeUInt8(1), r(t, e), a.connection.send(t, e);
          }
          spectateLockToggle() {
          ...
          stopMovement(e) {
            a.running &&
              ...
              a.events.$emit("update-cautions", { moveToCenterOfCells: e }));
          }
          lockLinesplit(e) {
            a.running &&
              ((e ??= !a.stopMovePackets) &&
                ...
                (e = a.dual.focused ? 2 : 1)),
              (a.stopMovePackets = e),
              a.events.$emit("update-cautions", { lockLinesplit: e }));
          }
          linesplit() {
            this.freezeMouse(!0),
              this.split(3, !0),
          ...
          zoom(e) {
            ...
            let i = Math.pow(t, s);
            a.mouseZoom = o(a.mouseZoom * i, a.mouseZoomMin, 1);
          }
          setZoomLevel(e) {
        ...
        <font color="${"#" + (t.nameColorCss || "ffffff")}">${
                  t.name
        ...
        `)
          ...
          findPlayerUnderMouse() {
            ...
            return (
              n.forEach((a) => {
                ...
                let n = a.x - e,
                  r = a.y - t,
                  o = Math.sqrt(Math.abs(n * n + r * r)) - a.size;
                if (o < s) (s = o), (i = a);
          ...
          toggleChat() {
            let e = !n.showChat;
            n.set("showChat", e),
              a.running && a.events.$emit("chat-visible", { visible: e });
          }
          toggleChatToast() {
            let e = !n.showChatToast;
            n.set("showChatToast", e),
              a.events.$emit("chat-visible", { visibleToast: e });
          }
        })();
      },
      ,
      ...
      function (e, t, s) {
                ...
                t(
                  ...
                  [
                    t("div", { staticClass: "bar" }, [
                      t("div", { attrs: { id: "vanis-io_728x90" } }),
                    ]),
                    this._v(" "),
                    t("servers", { staticClass: "fade-box two" }),
                    this._v(" "),
                    t("player-container", {
                    ...
                    this._v(" "),
                    t("account", { staticClass: "fade-box" }),
                    this._v(" "),
                    t("skins", { staticClass: "fade-box" }),
                  ],
                  1
                ),
              ]
                      ...
                      .catch((t) => {
                        localStorage.catchedServers
                          ? ((g = this.servers =
                            ...
                            (this.error = null),
                            e(!0))
                          : ((this.servers = g || []), (this.error = t), e(!1));
                      });
                },
              },
            },
                ...
                s("div", { attrs: { id: "player-data" } }, [
                  ...
                  s("div", { attrs: { id: "game-buttons" } }, [
                    s(
                      ...
                      [
                        e.gameState.deathDelay
                          ? s("i", { staticClass: "fas fa-sync fa-spin" })
                    ...
                    s(
                      "button",
                      {
                        attrs: {
                          ...
                          disabled:
                            !e.gameState.allowed ||
                            3 == e.gameState.lifeState ||
                            e.gameState.deathDelay,
                        },
                        on: { click: e.spectate },
                      },
                      [s("i", { staticClass: "fa fa-eye" })]
                    ),
                  ]),
                ]),
                e._v(" "),
            ...
            return s("div", { staticClass: "container" }, [
              s("div", { staticClass: "section row" }, [
                s("div", { staticClass: "header" }, [
                  e._v("\n            Renderer\n            "),
                  e.isWebGLSupported
                    ? s("span", { staticClass: "right silent" }, [e._v("")])
                    : e._e(),
                ]),
                e._v(" "),
                s(
                  ...
                  [
                    ...
                    e._v(" "),
                    s("div", { staticClass: "slider-option" }, [
                      e._v("\n            Renderer resolution "),
                ...
                s(
                  ...
                  [
                    ...
                    s(
                      ...
                      {
                        staticClass: "p-switch",
                        attrs: { checked: e.rememeberEjecting },
                        on: {
                          change: function (t) {
          ...
          Object(f.a)(
            {
              data: () => ({
                ...
                autoZoom: x.autoZoom,
                rememeberEjecting: x.rememeberEjecting,
                autoRespawn: x.autoRespawn,
                mbAutorespawn: x.mbAutorespawn,
                mouseFreezeSoft: x.mouseFreezeSoft,
                drawDelay: x.drawDelay,
                cameraMoveDelay: x.cameraMoveDelay,
                cameraZoomDelay: x.cameraZoomDelay,
                cameraZoomSpeed: x.cameraZoomSpeed,
                replayDuration: x.replayDuration,
                showReplaySaved: x.showReplaySaved,
                ...
                debugStats: x.debugStats,
                clientStats: x.clientStats,
                playerStats: x.playerStats,
                chatColorOnlyPeople: x.chatColorOnlyPeople,
                showBlockedMessageCount: x.showBlockedMessageCount,
                filterChatMessages: x.filterChatMessages,
                clearChatMessages: x.clearChatMessages,
                showCellLines: x.showCellLines,
                showTag: x.showTag,
                showDir: x.showDir,
                gameAlpha: x.gameAlpha,
                mbActive: x.mbActive,
              }),
              computed: {
                showNamesMeaning() {
                  return T(this.showNames);
                },
                showSkinsMeaning() {
                  return T(this.showSkins);
                },
                showMassMeaning() {
                  return T(this.showMass);
                },
              ...
              methods: {
                promptRestart() {
                  S.confirm("Refresh page to apply changes?", () => {
                    setTimeout(() => {
                      location.reload();
                    }, 500);
                  });
                  ...
                  if (
                    ...
                    switch (((this[e] = s), x.set(e, s), e)) {
                      ...
                      case "showHud":
                        ...
                        break;
                      case "showChatToast":
                        k.events.$emit("chat-visible", { visibleToast: s });
                    }
                    if (k.running)
                      switch (e) {
                        case "showNames":
                        ...
                        case "showRestartTiming":
                          ...
                          break;
                        case "showChat":
                          k.events.$emit("chat-visible", { visible: s });
                          break;
                ...
                reset() {
                  ...
                  for (var t in this.$data)
                    e.includes(t) || this.change(t, x.getDefault(t));
                },
              },
            },
            _,
            ...
            return s("div", { staticClass: "container" }, [
                ...
                s(
                  ...
                  [
                    ...
                    e.showNameFontWarning
                      ...
                      : e._e(),
                    e._v(" "),
                    s("div", { staticClass: "inline-range" }, [
                      s("input", {
                        staticClass: "slider",
              ...
              s("div", { staticClass: "reset-option-wrapper" }, [
                s(
                  ...
                  [s("i", { staticClass: "fa fa-undo" }), e._v(" Reset\n    ")]
                ),
              ]),
            ]);
          };
            ...
            [
              e.pickerOpen
                ? s(
                    ...
                    [
                      s("div", { staticClass: "color-picker-overlay" }),
                      e._v(" "),
                      s("div", { staticClass: "color-picker fade-box" }, [
                        s("input", {
                          directives: [
                            {
                              name: "model",
                        ...
                        s(
                          ...
                          [
                            s("div", { staticClass: "color-picker-sat" }, [
                              s("div", { staticClass: "color-picker-val" }, [
                                s("div", {
                        ...
                        e._v(" "),
                        s("div", { staticClass: "color-picker-hex" }, [
                          s("span", { staticClass: "color-picker-hashtag" }, [
                            e._v("#"),
                          ]),
                          e._v(" "),
                          s("input", {
        ...
        R.options.__file = "src/components/color-option.vue";
        var A = R.exports,
          N = function () {
            var e = this,
              t = e.$createElement,
            ...
            return s(
              ...
              [
                s("div", { staticClass: "image-button-text" }, [e._v("...")]),
                e._v(" "),
                e.pickerOpen
                  ? s(
                      "div",
                      ...
                      [
                        s("div", { staticClass: "image-picker-overlay" }),
                        e._v(" "),
                        s("div", { staticClass: "image-picker fade-box" }, [
                          s("img", {
        ...
        D.options.__file = "src/components/image-option.vue";
        var O = D.exports,
          B = function () {
            var e = this.$createElement;
        ...
        var V = PIXI.utils.isWebGLSupported() && W.useWebGL,
          K =
            (s(176),
            Object(f.a)(
              {
                components: { colorOption: A, imageOption: O },
                data: () => ({
                  useWebGL: V,
                ...
                methods: {
                  async change(e, t, s) {
                    ...
                    try {
                      switch (e) {
                        ...
                        case "backgroundImageUrl":
                          i !== this.bgDefault && (i = await G(i, 4e3));
                          break;
                        case "virusImageUrl":
                          i !== this.virusDefault && (i = await G(i, 200));
                          break;
                        case "mbArrow":
                          z.dual.reloadArrow(i);
                      }
                    } catch (a) {
                      return void H.alert(
                    ...
                    if (W[e] != i) {
                      ...
                      switch (((this[e] = i), e)) {
                        case "cursorImageUrl":
                          z.events.$emit("set-cursor-url", i);
                          break;
                        case "backgroundColor":
                          z.renderer.backgroundColor = PIXI.utils.string2hex(i);
                          break;
                        ...
                        case "cellNameSmoothOutline":
                          z.settings.compileNameFontStyle();
                          break;
                        case "cellMassColor":
                        ...
                        case "cellMassTextSize":
                          z.settings.compileMassFontStyle();
                          break;
                        case "cellLongNameThreshold":
                          z.scene.resetPlayerLongNames();
                      }
                      if (z.running)
                        switch (e) {
                          case "borderColor":
                            ...
                            break;
                          case "foodColor":
                            W.useFoodColor && z.scene.reloadFoodTextures();
                            break;
                          case "ejectedColor":
                            z.scene.reloadEjectedTextures();
                            break;
                          case "virusImageUrl":
                            z.scene.reloadVirusTexture();
                            break;
                          case "cellNameOutlineColor":
                          case "cellNameFont":
                          case "cellNameWeight":
                          ...
                          case "cellMassSmoothOutline":
                          case "cellMassTextSize":
                            z.scene.resetMassTextStyle(!0);
                            break;
                          case "showBackgroundImage":
                            z.scene.toggleBackgroundImage(i);
                            break;
                          case "backgroundImageUrl":
                          case "backgroundImageRepeat":
                          case "backgroundDefaultIfUnequal":
                          case "backgroundImageOpacity":
                            z.scene.setBackgroundImage();
                            break;
                          case "useFoodColor":
                            z.scene.reloadFoodTextures();
                        }
                    }
                  },
                  confirmReset() {
                  ...
                  reset() {
                    ...
                    for (var t in this.$data)
                      e.includes(t) || this.change(t, W.getDefault(t));
                  },
                  fontWarning(e, t) {
                    switch (e) {
                      case "name":
        ...
        K.options.__file = "src/components/theming.vue";
        var X = K.exports,
          Y = function () {
            var e = this,
              t = e.$createElement,
              s = e._self._c || t;
            return s("div", { attrs: { id: "hotkey-container" } }, [
              s(
                "div",
                { staticClass: "hotkeys" },
                e._l(e.availableHotkeys, function (t, i) {
                  return s("div", { key: i, staticClass: "row" }, [
                    s("span", { staticClass: "action" }, [e._v(e._s(i))]),
                    e._v(" "),
                    s(
                      "span",
                      {
            ...
            Object(f.a)(
              {
                ...
                methods: {
                  ...
                  onKeyDown: function (e, t) {
                    var s = J.convertKey(e.code);
                    "ESCAPE" !== s && "ENTER" !== s
                      ? ("DELETE" == s && (s = ""),
                        J.set(t, s) && ((this.hotkeys[t] = s), e.target.blur()))
                      : e.target.blur();
                  },
                },
              },
        ...
        var ee = Q.exports,
          et = function () {
            ...
            return s("div", { staticClass: "container" }, [
              ...
              e._v(" "),
              s("div", { staticClass: "replay-list-header" }, [
                s("span", { staticClass: "replay-list-count" }, [
                  e._v(
                    e._s(
                      e.keysLoadedFirst
                        ? e.replayKeys.length +
                ...
                e.keysLoadedFirst && !e.keysEmpty
                  ? s("span", { staticClass: "replay-list-page" }, [
                      s("div", { staticClass: "anchor" }, [
                        s("div", { staticClass: "left" }, [
                          s("div", { staticClass: "current" }, [
                            s("div", { staticClass: "phantom" }, [
                              s("i", {
                            ...
                            e.pageInputShown
                              ...
                              : s(
                                  ...
                                  [s("span", [e._v(e._s(1 + e.pageIndex))])]
                                ),
                            e._v(" "),
                            e.pageInputShown
                              ? s("div", { staticClass: "real-input" }, [
                                  s("div", {
                                    staticClass: "overlay",
                                    on: {
                                      click: function () {
                  ...
                  : e._e(),
                e._v(" "),
                s("span", { staticClass: "replay-list-bulk" }, [
                  s("input", {
              ...
              s(
                ...
                [
                  e.keysLoadedFirst && e.keysEmpty
                    ? [
                        s("div", { staticClass: "notification" }, [
                          s("div", [
                            e._v("Press "),
              ...
              e._v(" "),
              e.bulkOperating
                ? s("div", { staticClass: "overlay bulk-operation-overlay" }, [
                    e._v("\n        Please wait...\n        "),
                    e.bulkOperationStatus
                      ? s("div", { staticClass: "small" }, [
                          e._v(e._s(e.bulkOperationStatus)),
                        ])
                      : e._e(),
                    e._v(" "),
                    e.showMultipleFilesWarning
                      ? s("div", { staticClass: "small warning" }, [
                          e._v(
        ...
        var es = s(116),
          ...
          ed = {
            data: () => ({
              ...
              messageHotkey: er.get().saveReplay,
              messageReplayDuration: eo.replayDuration,
            }),
              ...
              async downloadAllReplays() {
                if (!this.bulkOperating && this.keysLoaded) {
                  ...
                  for (var a = 0, n = 0; a < e; a += 200, n++) {
                    for (var r = new ea(), o = a; o < a + 200 && o < e; o++) {
                      var l = this.replayKeys[o];
                      r.file(l + ".vanis", await eh.getItem(l));
                    }
                    var c = await r.generateAsync({ type: "blob" }),
                      h = "replays_" + i;
                    s && (h += "_" + (n + 1)),
                      (h += ".zip"),
                      ei.saveAs(c, h),
              ...
              async updateReplayPage(e) {
                ...
                for (
                  var a = 12 * this.pageIndex,
                    ...
                    r = a;
                  r < n && r < this.replayKeys.length && !i;
                  r++
                ) {
                  var o = this.replayKeys[r],
                    l = { name: o, data: await eh.getItem(o) };
          ...
          eu = (s(220), Object(f.a)(ed, et, [], !1, null, "4a996e52", null));
            ...
            Object(f.a)(
              {
                ...
                async created() {
                  let e = await eg.get("/leaderboard/season_xp/100");
                  if (!e.ok) return;
                  let t = await e.json();
                  (this.playerList = t.map((e) => ({
                    ...
                    ev.events.$on("every-second", this.setSeasonEndTime),
                    this.setSeasonEndTime();
                },
                destroyed() {
                  ev.events.$off("every-second", this.setSeasonEndTime);
                },
              },
              em,
              [],
        ...
        ew.options.__file = "src/components/meta-leaderboard.vue";
        var e$ = ew.exports,
          eb = (s(19), s(1)),
          eC =
            (s(5),
            {
              ...
              methods: {
                ...
                play() {
                  ...
                  } else eb.actions.join();
                  eb.showMenu(!1);
                },
                spectate() {
                  let { lifeState: e } = this.gameState;
                  1 & e || (eb.actions.spectate(), eb.showMenu(!1));
                },
                onSkinUrlChange() {
                  eb.events.$emit("skin-url-edit", this.skinUrl);
                },
                onTeamTagChange() {
        ...
        e_.options.__file = "src/components/player.vue";
        var ek = e_.exports,
          ex = function () {
            var e = this,
              t = e.$createElement,
              s = e._self._c || t;
            return s("div", { staticStyle: { padding: "12px 15px" } }, [
              e.account
                ? e._e()
                : s("div", [
                    s(
                ...
                ? s("div", { staticClass: "account" }, [
                    s("div", { staticStyle: { "margin-bottom": "3px" } }, [
                      ...
                      s("div", { staticClass: "player-info" }, [
                        ...
                        e._v(" "),
                        s("div", [e._v("Level " + e._s(e.account.level))]),
                        e._v(" "),
                        s("div", [e._v(e._s(e.account.xp) + " total XP")]),
                        e._v(" "),
                        s("div", [
                    ...
                    s(
                      ...
                      [
                        s("i", { staticClass: "fas fa-sign-out-alt" }),
                        e._v(" Logout\n    "),
                      ]
                    ),
                  ])
        ...
        var eS = function () {
          var e = this.$createElement,
            t = this._self._c || e;
          return t("div", { staticClass: "progress progress-striped" }, [
            t("div", {
        ...
        e8.options.__file = "src/components/progressBar.vue";
        var e0 = e8.exports,
          eM = s(228),
          eI = s(5),
          eT = s(1),
            ...
            Object(f.a)(
              {
                ...
                created() {
                  eT.events.$on("xp-update", this.onXpUpdate),
                    this.reloadUserData(),
                    this.listenForToken();
                },
                beforeDestroy() {
                  eT.events.$off("xp-update", this.onXpUpdate);
                },
                methods: {
                  listenForToken() {
                  ...
                  reloadUserData() {
                    Date.now() - this.accountTime <= 6e4 ||
                      ...
                      eM.vanisToken && this.loadUserData());
                  },
                  async loadUserData() {
                    this.loading = !0;
                    let e = await eM.get("/me");
                    if (!e.ok) {
                      (this.loading = !1),
                        console.error("Account:", e.status, e.statusText),
                        401 === e.status
                          ? eM.clearToken()
                          : 503 === e.status && eI.alert(await e.text());
                      return;
                    }
                    let t = await e.json();
                  ...
                  async logout() {
                    try {
                      await eM.call("DELETE", "/me");
                    } catch (e) {
                      var t = e.response;
                      t && 401 !== t.status && eI.alert("Error: " + e.message);
                    }
                    eM.clearToken(),
                      (this.account = null),
                      (this.name = null),
                  ...
                  setAccountData(e) {
                    e.permissions && (window.gameObj = eT),
                      (GAME.account = e),
                      (this.account = e),
                  ...
                  updateProgress(e, t) {
                    (this.xpAtCurrentLevel = eE.getXp(t)),
                      (this.xpAtNextLevel = eE.getXp(t + 1)),
                      (this.progress =
                  ...
                  openDiscordLogin: function () {
                    window.open(
                      eM.url + "/login/discord",
                      "",
                      "width=500, height=750"
                    );
                  },
                  onLoggedIn(e) {
                    eM.setToken(e), this.loadUserData();
                  },
                },
              },
              ex,
        ...
        eL.options.__file = "src/components/account.vue";
        var eP = eL.exports,
          eU = function () {
            var e = this,
              t = e.$createElement,
              s = e._self._c || t;
            return s("div", { attrs: { id: "skins-container" } }, [
              s(
                "div",
                { attrs: { id: "skins" } },
                [
                  e._l(e.skins, function (t, i) {
                    return s(
                      "span",
                      { key: i, staticClass: "skin-container" },
                      [
                        s("img", {
                          staticClass: "skin",
                          class: { selected: e.selectedSkinIndex === i },
                          attrs: { src: t, alt: "" },
                          on: {
                            click: function () {
        ...
        e1.options.__file = "src/components/skins.vue";
        var e3 = e1.exports,
          eR = s(1),
          eA =
            (s(234),
            ...
            [
              function () {
                ...
                return t("div", { staticClass: "container" }, [
                  ...
                  this._v(" "),
                  t("span", { staticClass: "line" }, [this._v("")]),
                  this._v(" "),
                  t("a", { attrs: { href: "tos.html", target: "_blank" } }, [
                    this._v(""),
                  ]),
                ]);
              },
        ...
        eB.options.__file = "src/components/privacy-tos.vue";
        var eF = eB.exports,
          e6 = function () {
            var e = this.$createElement,
              t = this._self._c || e;
            return this.show
              ? t(
                  ...
                  [
                    ...
                    t("div", [this._v("Block")]),
                    this._v(" "),
                    t("div", { on: { click: this.hideName } }, [
                      this._v("Hide Name"),
                    ]),
                    this._v(" "),
                    t("div", { on: { click: this.hideSkin } }, [
                      this._v("Hide Skin"),
                    ]),
                    this._v(" "),
                    t("div", [this._v("Kick")]),
        ...
        ez.options.__file = "src/components/context-menu.vue";
        var eW = ez.exports,
          eH = function () {
            var e = this.$createElement,
              t = this._self._c || e;
            ...
            Object(f.a)(
              {
                ...
                mounted() {
                  e7.events.$on("update-cautions", (e) => {
                    "mouseFrozen" in e &&
        ...
        ej.options.__file = "src/components/cautions.vue";
        var eZ = ej.exports,
          eG = function () {
            var e = this.$createElement,
              t = this._self._c || e;
            ...
            Object(f.a)(
              {
                data: () => ({
                  showFPS: eK.showFPS,
                  showPing: eK.showPing,
                  showPlayerMass: eK.showPlayerMass,
                  showPlayerScore: eK.showPlayerScore,
                  showCellCount: eK.showCellCount,
                  visible: !1,
                  ping: 0,
                  fps: 0,
                  mass: 0,
                ...
                created() {
                  eV.events.$on("stats-visible", (e) => (this.visible = e)),
                    eV.events.$on("stats-invalidate-shown", () => {
                      (this.showFPS = eK.showFPS),
                        (this.showPing = eK.showPing),
                        (this.showPlayerMass = eK.showPlayerMass),
                        (this.showPlayerScore = eK.showPlayerScore),
                        (this.showCellCount = eK.showCellCount);
                    }),
                    eV.events.$on("cells-changed", (e) => (this.cells = e)),
                    eV.events.$on("stats-changed", (e) => {
                      (this.ping = e.ping || 0),
                        (this.fps = e.fps || 0),
                        (this.mass = e.mass ? eV.getMassText(e.mass) : 0),
                        (this.score = e.score ? eV.getMassText(e.score) : 0);
                    });
                },
              },
              eG,
        ...
        eX.options.__file = "src/components/stats.vue";
        var eY = eX.exports,
          eJ = function () {
            var e = this,
              t = e.$createElement,
                                  ...
                                  ? [
                                      s(
                                        "span",
                                        {
                                          ...
                                          style: { color: t.fromColor },
                                          attrs: { "data-pid": t.pid },
                                        },
                                        [e._v(e._s(t.from))]
                                      ),
                                      e._v(":\n                "),
            ...
            Object(f.a)(
              {
                ...
                methods: {
                  onChatClick(e) {
                    ...
                    t &&
                      ((eq.selectedPlayer = t),
                      eq.actions.spectate(t),
                      eq.actions.targetPlayer(t));
                  },
                  onChatRightClick(e) {
                    var t = e.target.dataset.pid;
                    if (t) {
                      var s = eq.playerManager.getPlayer(t);
                      s
                        ? ts[t]
                  ...
                  sendChatMessage() {
                    ...
                    e &&
                      (eq.connection.sendChatMessage(e), (this.inputText = "")),
              ...
              [
                ...
                s(
                  ...
                  e._l(e.leaderboard, function (t, i) {
                    return s(
                      "div",
                      { key: i, staticClass: "leaderboard-label" },
                      [
                        e._v(" "),
                        s(
                          "span",
                          {
                            class: { spectating: 0 == e.gameState.lifeState },
                            style: {
                              color: t.color,
        ...
        var tr = s(1),
          ...
          tl =
            ...
            Object(f.a)(
              {
                data: () => ({
                  userVisible: to.showLeaderboard,
                  visible: !1,
                  headerVisible: !0,
                ...
                methods: {
                  ...
                  leftClickLabel() {
                    ...
                    e &&
                      ((tr.selectedPlayer = e),
                      tr.actions.spectate(e),
                      tr.actions.targetPlayer(e));
                  },
                  onLeaderboardShow() {
                    this.visible ||
                      (tr.events.$on(
                ...
                created() {
                  tr.events.$on(
                    ...
                    tr.events.$on("leaderboard-show", this.onLeaderboardShow),
                    tr.events.$on("leaderboard-hide", this.onLeaderboardHide);
                },
              },
              tn,
              [],
        ...
        var tc = tl.exports,
          ...
          td = (s(252), Object(f.a)(th, eH, [], !1, null, "339660d2", null));
          ...
          tp = function () {
            ...
            return s("transition", { attrs: { name: "menu" } }, [
              s("div", { staticClass: "container" }, [
                s("div", { staticClass: "fade-box box-1" }, [
                  ...
                  s(
                    ...
                    [s("div", { attrs: { id: "vanis-io_300x250_2" } })]
                  ),
                ]),
                e._v(" "),
                e.stats
                      ...
                      [
                        s(
                          ...
                          [
                            ...
                            e._v(" "),
                            s("div", [e._v("Highscore: " + e._s(e.highscore))]),
                            e._v(" "),
                            s("div", [
            ...
            Object(f.a)(
              {
                ...
                methods: {
                  loadAd() {
                    this.isLoadingAd = tv.refreshAd("death-box");
                  },
                  onContinueClick() {
        ...
        tg.options.__file = "src/components/death-stats.vue";
        var tf = tg.exports,
          ty = function () {
            var e = this.$createElement;
        ...
        ty._withStripped = !0;
        var tw = (s(256), Object(f.a)({}, ty, [], !1, null, "b0b10308", null));
        tw.options.__file = "src/components/btn.vue";
        var t$ = tw.exports,
          tb = function () {
            var e = this,
              t = e.$createElement,
            ...
            return e.show
              ? s(
                  ...
                  [
                    s("div", { staticStyle: { "text-align": "right" } }, [
                      s("div", [e._v("Opacity " + e._s(e.cellOpacity) + "%")]),
                      e._v(" "),
                      s("div", [
                        s("input", {
                          directives: [
                    ...
                    s(
                      ...
                      [
                        s("div", { staticStyle: { flex: "1" } }, [
                          e._v(e._s(e.replaySecond.toFixed(1)) + " seconds"),
                        ]),
                        e._v(" "),
                        s("div", { staticStyle: { "margin-right": "10px" } }, [
                          s("input", {
                            directives: [
                              {
                                name: "model",
        ...
        t_.options.__file = "src/components/replay-controls.vue";
        var tk = t_.exports,
          tx = function () {
            var e = this.$createElement,
              t = this._self._c || e;
            return this.show
              ? t("div", { attrs: { id: "ab-overlay" } }, [this._m(0)])
              : this._e();
          };
        (tx._withStripped = !0), s(19);
        var { isFirstVisit: tS } = s(17),
          t8 =
            (s(260),
            Object(f.a)(
              { data: () => ({ show: !1 }), created() {} },
        ...
        t8.options.__file = "src/components/ab-overlay.vue";
        var t0 = t8.exports,
          tM = function () {
            var e = this.$createElement;
            return (this._self._c || e)(
        ...
        var tT = (window.captcha = {
            ...
            methods: {
              ...
              onCaptchaToken(e) {
                ...
                tI.connection.sendRecaptchaToken(e, !!this.multibox),
                  (this.show = !1);
              },
            },
          }),
        ...
        tE.options.__file = "src/components/image-captcha.vue";
        var tL = tE.exports,
          tP = function () {
            var e = this,
              t = e.$createElement,
            ...
            Object(f.a)(
              {
                ...
                methods: {
                  hide() {
                    tU.setSeen(this.tag), (this.show = !1);
                  },
                },
                created() {
                  tU.isSeen(this.tag) || (this.show = !0);
                },
              },
              tP,
              [],
        ...
        t4.options.__file = "src/components/shoutbox.vue";
        var t1 = t4.exports;
        a.a.use(r.a);
        var t3 = s(4),
          tR = s(1);
  ...
  (o.id = "debugStats"),
    ...
    (o.style.fontWeight = "100"),
    (o.style.opacity = "0.8"),
    (o.style.display = "block"),
    $("#hud").appendChild(o),
    (GAME.debugElement = o),
    ((o = document.createElement("div")).id = "playerStats"),
    (o.style.position = "fixed"),
    (o.style.left = "10px"),
    (o.style.top = "150px"),
    (o.style.fontWeight = "100"),
    ...
    ((o = document.createElement("div")).id = "playerList"),
    (o.style.position = "fixed"),
    (o.style.left = "10px"),
    (o.style.top = "10px"),
    (o.style.fontWeight = "100"),
    (o.style.zIndex = "999"),
    (o.style.opacity = "0.9"),
    (o.style.backdropFilter = "blue(5px)"),
    (o.style.display = "block"),
    $("#app").appendChild(o),
    ((o = document.createElement("div")).id = "playerSkins"),
    (o.style.position = "fixed"),
    (o.style.right = "10px"),
    (o.style.top = "10px"),
    (o.style.fontWeight = "100"),
...
<div data-v-3ddebeb3="" class="p-switch pretty" p-checkbox="" style="float:left;margin-top:4px"><input type="checkbox" id="mbUseName" onchange="window.setMultiData(3)" ${
        ...
        e.split("\n").forEach((e) => {
          if ("" != e) {
            ...
            s.startsWith("!") ||
              (window.emojis[
                i
              ] = `https://cdn.discordapp.com/emojis/${s}.${a}`);
          }
        });
    }),
    ($(".bar").innerHTML =
    ...
    (() => {
      if ("experiment" !== localStorage.noteShown) {
        let e = {
          title: "This is an experimental build!",
          html: atob(
            "PGJyPklmIHlvdSBoYXZlIGFueSBidWdzLCBwbGVhc2UgYmUgc3VyZSB0byByZXBvcnQgdGhlbSBpbiB0aGUgPGEgc3R5bGU9ImNvbG9yOiAjNGE2N2NmIiBocmVmPSJodHRwczovL2JpdC5seS9heG9uLWRpc2NvcmQiPkRpc2NvcmQ8L2E+IDxiPiNzdXBwb3J0PC9iPiBjaGFubmVsIQ=="
          ),
          confirmButtonText: "Okay",
        };
        Swal.fire(e), localStorage.setItem("noteShown", "experiment");
      }
    })();
})();
